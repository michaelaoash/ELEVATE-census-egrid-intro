...
filter(hampden_VTD_2010,grepl('Holyoke', NAME20, ignore.case=TRUE ))
...
sf_use_s2(FALSE)  ## Aagh don't understand
...
ggplot(holyoke_blockgroups_acs2020) +
    geom_sf(aes(fill=percent_families_with_children_in_poverty), lwd=0) +
    ...
    geom_sf(data=holyoke_VTD_2020, color="orange", fill=NA) +
